...
data:extend({
    ...
    },
    {
        ...
        ingredients =
        {
            { type = "fluid", name = "o2", amount = 4000 },
    ...
    },
    {
        ...
        {
            { "plant-1", 1 },
            { type = "fluid", name = "polluted-oxygen", amount = 2600 },
        },
        results =
        {
            { "polluted-dirt", 1 },
    ...
    -- 3
    {
        ...
        ingredients =
        {
            { type = "fluid", name = "o2", amount = 5000 },
    ...
    },
    {
        ...
        ingredients =
        {
            { type = "fluid", name = "o2", amount = 2600 },
            { "plant-3-2", 4 },
        },
        results =
        {
    ...
    --    4
    {
        ...
        results =
        {
            ...
            { "oversize-garbage", 1 },
            { "general-waste", 1 },
            { type = "fluid", name = "co2", amount = 2800 },
    ...
    --    6
    {
        ...
        results =
        {
            ...
            { "oversize-garbage", 30 },
            { "general-waste", 40 },
            { type = "fluid", name = "co2", amount = 4200 },
    ...
    },
    {
        ...
        {
            { "plant-6-1", 1 },
            { type = "fluid", name = "polluted-oxygen", amount = 600 },
        }
    },
    {
        type = "recipe",
    ...
    },
    {
        ...
        {
            { "plant-6-3", 1 },
            { type = "fluid", name = "natural-gas", amount = 800 },
        }
    },
    {
        type = "recipe",
